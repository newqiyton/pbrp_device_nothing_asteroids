...
# Force API levels to match PBRP source (API 34)
...
# TW/PB config
# This device tree is very different from other ones
...
# PBRP flags
PB_OFFICIAL := false
PB_DEVICE_NAME := Nothing Phone (3a) / Pro
PB_MAINTAINER := Im qiyton
PB_USE_A_B_SLOTS := true
PB_V_A_B := true
